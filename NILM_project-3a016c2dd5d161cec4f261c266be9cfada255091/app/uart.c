...
UartModemEvents_t Uart1ModemEvents;
 ...
 int dataReady = 0;   //initialize to false
//number strings from Smartbox
Int8U dataArray[55];
//for number data 
Flo64 dataP[50];
Flo64 dataQ[50];
...
Int8U Data;
  ...
  case RDA_INTR_ID: // Receive Data Available
    ...
    ///////////////////////////////////////////////////////////////////////////////////
    LineStatus = U0LSR;
    //The dataArray not yet full.
    if(!dataReady && LineStatus & RLS_ReceiverDataReady ){
      Data = U0RBR;   
      //debug
      //GLCD_print("%c",Data);
      //
 ...
 * Return: Int32U
 *
* Description: 1: ready to print to LCD,    0: not ready to print to screen(therefore,
keep filling the array)
 *
 *************************************************************************/
/*void UartPrint(int i)
{
  readReady=i;
  return;
}*/
